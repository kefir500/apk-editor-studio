...
namespace Dialogs
{
    QString getOpenFilename(QWidget *parent = nullptr, const QString &defaultPath = QString(), bool filterExtension = true);
    QString getSaveFilename(QWidget *parent = nullptr, const QString &defaultPath = QString(), bool filterExtension = true);
    QStringList getOpenFilenames(QWidget *parent = nullptr, const QString &defaultPath = QString(), bool filterExtension = true);
